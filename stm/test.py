...
def run_test_for_folder(folder: str):
    ...
    for entry in os.scandir(folder):
        if entry.is_file() and entry.path.endswith(STM_EXT):
...
def usage(exe_name: str):
    ...
    print("  SUBCOMMAND:")
    print("    run [TARGET]")
    print("      Run the test on the [TARGET]. The [TARGET] is either a *.stm file or ")
    print("      folder with *.stm files. The default [TARGET] is './examples/'.")
    print()
    ...
    print()
    print("        output [TARGET]")
    print("          Update the output of the [TARGET]. The [TARGET] is either a *.stm")
    print("          file or folder with *.stm files. The default [TARGET] is")
    print("          './examples/'")
    print()
